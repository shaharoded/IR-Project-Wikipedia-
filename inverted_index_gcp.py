...
PROJECT_ID = 'ir-assignment-3-413716'
...
class InvertedIndex:  
    def __init__(self, docs={}):
        ...
        """
        # Enrich init with additional helpful info:
        # Number of Documents
        self.N = None
        
        # AVG Length of documents in the Index, for similarity calculations
        self.AVG_doc_length = 0
        
        # Additional document info: {doc_id: (title ,doc_size)}
        self.additional_info = {}
        
        # Doc_Vectors - TF-IDF sparse vector per document
        self.doc_vectors = {}
        
        # stores document frequency data per term {term: (index, idf)} - TermData
        self.term_data = {}
        
        # {term: df} - For reading premade integration
        self.df = Counter()
        
        # stores posting list per term while building the index (internally), 
        # otherwise too big to store in memory.
        self._posting_list = defaultdict(list)  # {term: [(doc_id, tf),(doc_id, tf)]}
